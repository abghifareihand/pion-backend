...
>
    ...
    >
        ...
        <div
            ...
            @click="close()"
            style="position: absolute; top: 0; left: 0; right: 0; bottom: 0; background-color: rgba(15, 23, 42, 0.6); backdrop-filter: blur(4px);"
        ></div>
                ...
                <div style="padding: 1.5rem;">
                    <div style="display: flex; align-items: flex-start; gap: 1rem;">
                        <div
                            ...
                            :style="type === 'danger' ? 'background-color: #fee2e2;' : (type === 'warning' ? 'background-color: #fef3c7;' : 'background-color: #fef2f2;')"
                        >
                            <svg
                                style="width: 1.5rem; height: 1.5rem;"
                                :style="type === 'danger' ? 'color: #dc2626;' : (type === 'warning' ? 'color: #d97706;' : 'color: #AA2224;')"
                                fill="none"
                                viewBox="0 0 24 24"
                                stroke-width="1.5"
                                stroke="currentColor"
                ...
                <div style="background-color: #f8fafc; padding: 1rem 1.5rem; display: flex; justify-content: flex-end; gap: 0.75rem;">
                    ...
                    <form x-ref="confirmForm" method="POST" style="display: inline; margin: 0;">
                        ...
                        <button
                            ...
                            @click="confirm()"
                            class="btn"
                            :class="type === 'danger' ? 'btn-danger' : (type === 'warning' ? 'btn-accent' : 'btn-primary')"
                            x-text="confirmText"
                        ></button>
                    </form>
                </div>
