...
@section('breadcrumb')
    ...
    <span class="text-slate-700 font-medium">Tambah Struktur</span>
@endsection
...
<div class="w-full space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            <h1 class="text-2xl font-bold text-slate-900 tracking-tight">Tambah Struktur Organisasi</h1>
            <p class="text-slate-500 text-sm mt-0.5">Unggah bagan kepengurusan dan susunan organisasi SP PION.</p>
        </div>
        ...
        <form method="POST" action="{{ route('organizations.store') }}" enctype="multipart/form-data">
            ...
            <div class="card-body space-y-5">
                ...
                <div>
                    ...
                    <input class="input @error('title') border-red-500 @enderror" type="text" id="title" name="title" value="{{ old('title') }}" placeholder="Contoh: Susunan Pengurus Periode 2024-2027" required />
                ...
                <div>
                    ...
                    <textarea class="input @error('description') border-red-500 @enderror" id="description" name="description" rows="4" placeholder="Keterangan tambahan mengenai susunan organisasi">{{ old('description') }}</textarea>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    {{-- Foto / Diagram --}}
                    <div>
                        <label class="form-label" for="image">Foto Bagan Organisasi</label>
                    ...
                    {{-- File Dokumen SK --}}
                    <div>
                        <label class="form-label" for="file">Berkas SK / Dokumen Resmi</label>
