...
@section('breadcrumb')
    ...
    <span class="text-slate-700 font-medium">Buat Informasi</span>
@endsection
...
<div class="max-w-4xl space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            <h1 class="text-2xl font-bold text-slate-900 tracking-tight">Buat Informasi Baru</h1>
            <p class="text-slate-500 text-sm mt-0.5">Publikasikan pengumuman atau artikel untuk seluruh anggota serikat.</p>
        </div>
        ...
        <form method="POST" action="{{ route('informations.store') }}" enctype="multipart/form-data">
            ...
            <div class="card-body space-y-5">
                ...
                <div>
                    ...
                    <input class="input @error('title') border-red-500 @enderror" type="text" id="title" name="title" value="{{ old('title') }}" placeholder="Masukkan judul pengumuman / informasi" required />
                ...
                <div>
                    ...
                    <textarea class="input @error('description') border-red-500 @enderror" id="description" name="description" rows="5" placeholder="Tulis isi pengumuman atau berita">{{ old('description') }}</textarea>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    {{-- Foto --}}
                    <div>
                        <label class="form-label" for="image">Lampiran Foto (Cover)</label>
                    ...
                    {{-- File Dokumen --}}
                    <div>
                        <label class="form-label" for="file">Berkas Dokumen Pendukung</label>
                        <x-file-input id="file" name="file" accept=".pdf,.doc,.docx" />
                        <p class="form-help text-xs text-slate-500 mt-1">Format: PDF, DOC, DOCX (Maks 5MB)</p>
